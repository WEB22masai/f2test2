...
function filterTable() {
  ...
  const searchText = searchInput.value.toLowerCase(); // Convert input to lowercase for case-insensitive search
  ...
  const filteredStudents = students.filter(student => {
      ...
      // Check if the search text matches any part of first name, last name, or email
...
function renderTable(data) {
  ...
  data.forEach(student => {
      ...
      const image = document.createElement("img");
        ...
        // Add the image and full name to the "Name" cell
...
// Initial rendering of the table with sample data
renderTable(students);

// Implement sorting functions and search functionality as needed

// Example sorting function (replace with actual sorting logic)
